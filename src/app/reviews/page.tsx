...
function ReviewsPageContent() {
    ...
    const toggleExpand = (review: ParseReviewItem) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {isExpanded && isPending && (
                                    <div className="mt-3 p-4 bg-blue-50/50 rounded-lg border border-blue-100 space-y-3">
